...
mod app_init {
    ...
    pub fn generate_handlers() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
        tauri::generate_handler![
            ...
            cmd::open_app_dir,
            cmd::open_logs_dir,
            cmd::read_speed_test_urls_config_file,
            cmd::save_speed_test_urls_config_file,
            cmd::reset_speed_test_urls_config_file,
            cmd::open_speed_test_urls_config_file,
            cmd::open_web_url,
            cmd::open_core_dir,
            ...
            cmd::test_delay,
            cmd::test_proxy_download_speed,
            cmd::cancel_proxy_download_speed_tests,
            cmd::get_app_dir,
            cmd::copy_icon_file,
