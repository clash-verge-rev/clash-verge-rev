...
export const EnhancedCanvasTrafficGraph = memo(
  function EnhancedCanvasTrafficGraph({
    ...
    const pause_render_traffic_stats_on_blur = verge.verge?.pause_render_traffic_stats_on_blur ?? true;
    ...
    }, [drawGraph, displayData.length, isWindowFocused || !pause_render_traffic_stats_on_blur, collectFrameSample]);
