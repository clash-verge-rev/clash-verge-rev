...
import type { WindowControlsHandle } from "@/hooks/use-window";
import getSystem from "@/utils/get-system";

export type { WindowControlsHandle } from "@/hooks/use-window";

export const WindowControls = forwardRef<WindowControlsHandle>(
  function WindowControls(_props, ref) {
    const OS = getSystem();
    const {
      currentWindow,
      maximized,
