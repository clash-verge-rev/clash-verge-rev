...
export const translationKeys = [
  ...
  'gateway.page.title',
  'gateway.page.description',
  'gateway.page.status',
  'gateway.page.enabled',
  'gateway.page.disabled',
  'gateway.page.interface',
  'gateway.page.gatewayAddress',
  'gateway.page.dnsAddress',
  'gateway.page.hijackDns',
  'gateway.page.start',
  'gateway.page.stop',
  'gateway.page.devices',
  'gateway.page.device',
  'gateway.page.policy',
  'gateway.page.followRules',
  'gateway.page.connections',
  'gateway.page.upload',
  'gateway.page.download',
  'gateway.page.empty',
  'gateway.page.clientHelp',
  'gateway.page.selectInterfaceError',
  'gateway.page.dhcpServer',
  'gateway.page.dhcpDescription',
  'gateway.page.dhcpWarning',
  'gateway.page.running',
  'gateway.page.stopped',
  'gateway.page.poolStart',
  'gateway.page.poolEnd',
  'gateway.page.subnetMask',
  'gateway.page.router',
  'gateway.page.dhcpDns',
  'gateway.page.leaseHours',
  'gateway.page.activeConnections',
  'gateway.page.trafficStatistics',
  'gateway.page.clearLeases',
  'gateway.page.macAddress',
  'gateway.page.totalTraffic',
  'gateway.page.online',
  'gateway.page.offline',
  'gateway.page.source',
  'gateway.page.destination',
  'gateway.page.rule',
  'gateway.page.proxy',
  'gateway.page.protocol',
  'gateway.page.noConnections',
  'gateway.page.totalDevices',
  'gateway.page.deviceFilter',
  'gateway.page.searchDevices',
  'gateway.page.manage',
  'gateway.page.editDevice',
  'gateway.page.customName',
  'gateway.page.deviceIcon',
  'gateway.page.fixedIp',
  'gateway.page.fixedIpAddress',
  'gateway.page.fixedIpPlaceholder',
  'gateway.page.fixedIpHelp',
  'gateway.page.lastSeen',
  'gateway.page.cancel',
  'gateway.page.save',
  'gateway.page.deviceSaved',
  'gateway.page.deviceNeedsMac',
  'gateway.page.fixedIpSubnetError',
  'gateway.page.fixedIpDuplicateError',
  'gateway.page.reconnectForFixedIp',
  'gateway.page.owner',
  'gateway.page.deviceGroup',
  'gateway.page.group_family',
  'gateway.page.group_guest',
  'gateway.page.group_iot',
  'gateway.page.group_work',
  'gateway.page.group_infrastructure',
  'gateway.page.group_unknown',
  'gateway.page.trusted',
  'gateway.page.trustedDevice',
  'gateway.page.blockInternet',
  'gateway.page.pauseInternet',
  'gateway.page.resumeInternet',
  'gateway.page.internetPaused',
  'gateway.page.internetResumed',
  'gateway.page.blockedDomains',
  'gateway.page.blockedDomainsPlaceholder',
  'gateway.page.blockedDomainsHelp',
  'gateway.page.blockedPorts',
  'gateway.page.blockedPortsHelp',
  'gateway.page.deviceNotes',
  'gateway.page.deviceNotesHelp',
  'gateway.page.invalidPorts',
  'gateway.page.invalidDomains',
  'gateway.page.onlineDevices',
  'gateway.page.untrustedDevices',
  'gateway.page.blockedDevices',
  ...
  'home.components.ipInfo.errors.loadWithDetails',
  'home.components.ipInfo.errors.noServices',
  ...
  'home.components.currentProxy.status.error',
  'home.components.currentProxy.status.timeout',
  'home.components.currentProxy.status.latencyHigh',
  'home.components.currentProxy.status.latencyMedium',
  'home.components.currentProxy.status.latencyGood',
  'home.components.currentProxy.status.latencyExcellent',
  'home.components.currentProxy.status.uninitialized',
  'home.components.currentProxy.status.noProxyNode',
  ...
  'layout.components.navigation.tabs.gateway',
  ...
  'profiles.page.feedback.errors.createFailed',
  'profiles.page.feedback.errors.deleteFailed',
  'profiles.page.feedback.errors.enhanceFailed',
  'profiles.page.feedback.errors.importFailed',
  'profiles.page.feedback.errors.openFailed',
  'profiles.page.feedback.errors.readFailed',
  'profiles.page.feedback.errors.reorderFailed',
  'profiles.page.feedback.errors.switchFailed',
  'profiles.page.feedback.errors.updateFailed',
  ...
  'profiles.modals.profileForm.fields.userAgent',
  ...
  'proxies.page.empty.noAvailableGroups',
  'proxies.page.empty.noProxies',
  ...
  'tests.modals.test.errors.nameRequired',
  'tests.modals.test.errors.urlRequired',
  'tests.modals.test.errors.invalidSvg',
  'tests.modals.test.errors.uidMissing',
  'tests.modals.test.errors.saveFailed',
