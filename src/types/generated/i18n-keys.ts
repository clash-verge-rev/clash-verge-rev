...
export const translationKeys = [
  ...
  'connections.components.actions.addIpRule',
  'connections.components.actions.addProcessPathRule',
  ...
  'profiles.modals.proxiesEditor.actions.manual',
  'profiles.modals.proxiesEditor.actions.prepend',
  'profiles.modals.proxiesEditor.actions.append',
  'profiles.modals.manualProxy.title',
  'profiles.modals.manualProxy.editTitle',
  'profiles.modals.manualProxy.sections.server',
  'profiles.modals.manualProxy.sections.protocol',
  'profiles.modals.manualProxy.sections.transport',
  'profiles.modals.manualProxy.sections.tls',
  'profiles.modals.manualProxy.sections.plugin',
  'profiles.modals.manualProxy.sections.obfs',
  'profiles.modals.manualProxy.sections.interface',
  'profiles.modals.manualProxy.sections.options',
  'profiles.modals.manualProxy.fields.name',
  'profiles.modals.manualProxy.fields.protocol',
  'profiles.modals.manualProxy.fields.server',
  'profiles.modals.manualProxy.fields.port',
  'profiles.modals.manualProxy.fields.username',
  'profiles.modals.manualProxy.fields.password',
  'profiles.modals.manualProxy.fields.tuicPassword',
  'profiles.modals.manualProxy.fields.auth',
  'profiles.modals.manualProxy.fields.cipher',
  'profiles.modals.manualProxy.fields.uuid',
  'profiles.modals.manualProxy.fields.alterId',
  'profiles.modals.manualProxy.fields.flow',
  'profiles.modals.manualProxy.fields.token',
  'profiles.modals.manualProxy.fields.congestionController',
  'profiles.modals.manualProxy.fields.ports',
  'profiles.modals.manualProxy.fields.up',
  'profiles.modals.manualProxy.fields.down',
  'profiles.modals.manualProxy.fields.privateKey',
  'profiles.modals.manualProxy.fields.publicKey',
  'profiles.modals.manualProxy.fields.preSharedKey',
  'profiles.modals.manualProxy.fields.ssrProtocol',
  'profiles.modals.manualProxy.fields.ssrObfs',
  'profiles.modals.manualProxy.fields.protocolParam',
  'profiles.modals.manualProxy.fields.obfsParam',
  'profiles.modals.manualProxy.fields.network',
  'profiles.modals.manualProxy.fields.wsPath',
  'profiles.modals.manualProxy.fields.wsHost',
  'profiles.modals.manualProxy.fields.grpcServiceName',
  'profiles.modals.manualProxy.fields.h2Path',
  'profiles.modals.manualProxy.fields.h2Host',
  'profiles.modals.manualProxy.fields.sni',
  'profiles.modals.manualProxy.fields.servername',
  'profiles.modals.manualProxy.fields.alpn',
  'profiles.modals.manualProxy.fields.fingerprint',
  'profiles.modals.manualProxy.fields.clientFingerprint',
  'profiles.modals.manualProxy.fields.realityPublicKey',
  'profiles.modals.manualProxy.fields.realityShortId',
  'profiles.modals.manualProxy.fields.plugin',
  'profiles.modals.manualProxy.fields.pluginMode',
  'profiles.modals.manualProxy.fields.pluginHost',
  'profiles.modals.manualProxy.fields.pluginPath',
  'profiles.modals.manualProxy.fields.obfs',
  'profiles.modals.manualProxy.fields.obfsPassword',
  'profiles.modals.manualProxy.fields.ip',
  'profiles.modals.manualProxy.fields.ipv6',
  'profiles.modals.manualProxy.fields.dns',
  'profiles.modals.manualProxy.fields.mtu',
  'profiles.modals.manualProxy.fields.persistentKeepalive',
  'profiles.modals.manualProxy.fields.ipVersion',
  'profiles.modals.manualProxy.fields.interfaceName',
  'profiles.modals.manualProxy.fields.dialerProxy',
  'profiles.modals.manualProxy.placeholders.name',
  'profiles.modals.manualProxy.toggles.tls',
  'profiles.modals.manualProxy.toggles.skipCertVerify',
  'profiles.modals.manualProxy.toggles.udp',
  'profiles.modals.manualProxy.toggles.tfo',
  'profiles.modals.manualProxy.options.none',
  'profiles.modals.manualProxy.options.default',
  'profiles.modals.manualProxy.errors.nameRequired',
  'profiles.modals.manualProxy.errors.nameExists',
  'profiles.modals.manualProxy.errors.serverRequired',
  'profiles.modals.manualProxy.errors.portRequired',
  'profiles.modals.manualProxy.errors.portInvalid',
  'profiles.modals.manualProxy.errors.passwordRequired',
  'profiles.modals.manualProxy.errors.authRequired',
  'profiles.modals.manualProxy.errors.uuidRequired',
  'profiles.modals.manualProxy.errors.privateKeyRequired',
  'profiles.modals.manualProxy.errors.publicKeyRequired',
  'profiles.modals.manualProxy.errors.ipRequired',
  'profiles.modals.manualProxy.errors.dialerSelf',
  'profiles.modals.manualProxy.errors.dialerCycle',
  'profiles.modals.manualProxy.errors.noProfile',
  'profiles.modals.manualProxy.errors.notEditable',
  'profiles.modals.manualProxy.actions.prepend',
  'profiles.modals.manualProxy.actions.append',
  'profiles.modals.manualProxy.actions.edit',
  'profiles.modals.manualProxy.actions.duplicate',
  'profiles.modals.manualProxy.actions.delete',
  'profiles.modals.manualProxy.deleteConfirm.title',
  'profiles.modals.manualProxy.deleteConfirm.message',
  'profiles.modals.deleteDependency.deleteAndClean',
  'profiles.modals.deleteDependency.groupRefsTitle',
  'profiles.modals.deleteDependency.groupRefsHint',
  'profiles.modals.deleteDependency.fallbackHint',
  'profiles.modals.deleteDependency.ruleRefsTitle',
  'profiles.modals.deleteDependency.ruleRefsHint',
  'profiles.modals.deleteDependency.noRefs',
  'profiles.modals.deleteDependency.blockedNotice',
  'profiles.modals.manualGroup.title',
  'profiles.modals.manualGroup.editTitle',
  'profiles.modals.manualGroup.steps.0',
  'profiles.modals.manualGroup.steps.1',
  'profiles.modals.manualGroup.steps.2',
  'profiles.modals.manualGroup.types.select.title',
  'profiles.modals.manualGroup.types.select.description',
  'profiles.modals.manualGroup.types.urlTest.title',
  'profiles.modals.manualGroup.types.urlTest.description',
  'profiles.modals.manualGroup.types.fallback.title',
  'profiles.modals.manualGroup.types.fallback.description',
  'profiles.modals.manualGroup.types.loadBalance.title',
  'profiles.modals.manualGroup.types.loadBalance.description',
  'profiles.modals.manualGroup.types.relay.title',
  'profiles.modals.manualGroup.types.relay.description',
  'profiles.modals.manualGroup.sections.policies',
  'profiles.modals.manualGroup.sections.external',
  'profiles.modals.manualGroup.policyGroups.builtin',
  'profiles.modals.manualGroup.policyGroups.proxies',
  'profiles.modals.manualGroup.policyGroups.groups',
  'profiles.modals.manualGroup.policyGroups.other',
  'profiles.modals.manualGroup.fields.name',
  'profiles.modals.manualGroup.fields.url',
  'profiles.modals.manualGroup.fields.interval',
  'profiles.modals.manualGroup.fields.tolerance',
  'profiles.modals.manualGroup.fields.strategy',
  'profiles.modals.manualGroup.fields.icon',
  'profiles.modals.manualGroup.fields.filter',
  'profiles.modals.manualGroup.fields.excludeFilter',
  'profiles.modals.manualGroup.fields.includeAll',
  'profiles.modals.manualGroup.fields.includeAllProxies',
  'profiles.modals.manualGroup.fields.includeAllProviders',
  'profiles.modals.manualGroup.fields.lazy',
  'profiles.modals.manualGroup.fields.disableUdp',
  'profiles.modals.manualGroup.fields.hidden',
  'profiles.modals.manualGroup.options.default',
  'profiles.modals.manualGroup.errors.nameRequired',
  'profiles.modals.manualGroup.errors.nameExists',
  'profiles.modals.manualGroup.errors.policiesRequired',
  'profiles.modals.manualGroup.errors.notEditable',
  'profiles.modals.manualGroup.actions.add',
  'profiles.modals.manualGroup.actions.next',
  'profiles.modals.manualGroup.actions.back',
  'profiles.modals.manualGroup.actions.prepend',
  'profiles.modals.manualGroup.actions.append',
  'profiles.modals.manualGroup.actions.edit',
  'profiles.modals.manualGroup.actions.duplicate',
  'profiles.modals.manualGroup.actions.delete',
  'profiles.modals.manualGroup.actions.options',
  'profiles.modals.manualGroup.deleteConfirm.title',
  'profiles.modals.manualGroup.deleteConfirm.message',
  ...
  'proxies.page.sections.proxy',
  'proxies.page.sections.proxyGroup',
  ...
  'rules.page.title',
  'rules.page.actions.add',
  'rules.page.actions.standard',
  'rules.page.actions.logical',
  'rules.page.actions.ruleset',
  'rules.page.actions.edit',
  'rules.page.actions.duplicate',
  'rules.page.actions.delete',
  'rules.page.table.id',
  'rules.page.table.type',
  ...
  'rules.page.policyGroups.proxies',
  'rules.page.policyGroups.groups',
  'rules.page.policyGroups.other',
  ...
  'rules.modals.editor.form.helpers.geosite',
  ...
  'rules.modals.editor.form.validation.subrulesRequired',
  'rules.modals.editor.form.validation.subruleConditionRequired',
  'rules.modals.editor.form.validation.invalidRule',
  'rules.modals.editor.logical.operator',
  'rules.modals.editor.logical.addSubrule',
  'rules.modals.editor.logical.standardSubrule',
  'rules.modals.editor.logical.logicalSubrule',
  'rules.modals.editor.logical.rulesetSubrule',
  'rules.modals.editor.logical.configureSubrule',
