...
export const translationKeys = [
  ...
  'proxies.page.empty.noSubscriptions.title',
  'proxies.page.empty.noSubscriptions.description',
  'proxies.page.empty.inactiveSubscription.title',
  'proxies.page.empty.inactiveSubscription.description',
  'proxies.page.empty.coreUnavailable.title',
  'proxies.page.empty.coreUnavailable.description',
  'proxies.page.empty.noProxyInfo.title',
  'proxies.page.empty.noProxyInfo.description',
  'proxies.page.empty.actions.openProfiles',
  'proxies.page.empty.actions.restartCore',
  'proxies.page.empty.actions.openLogs',
  ...
  'settings.modals.wslProxy.title',
  'settings.modals.wslProxy.actions.restart',
  'settings.modals.wslProxy.actions.documentation',
  'settings.modals.wslProxy.actions.applyOff',
  'settings.modals.wslProxy.actions.reapply',
  'settings.modals.wslProxy.fields.proxyIntegration',
  'settings.modals.wslProxy.fields.autoProxy',
  'settings.modals.wslProxy.fields.proxyEndpoint',
  'settings.modals.wslProxy.fields.networkingMode',
  'settings.modals.wslProxy.fields.distributions',
  'settings.modals.wslProxy.fields.compatibility',
  'settings.modals.wslProxy.values.mirrored',
  'settings.modals.wslProxy.values.other',
  ...
  'settings.modals.wslProxy.support.ready',
  'settings.modals.wslProxy.support.notWindows',
  'settings.modals.wslProxy.support.notInstalled',
  'settings.modals.wslProxy.support.updateWindows',
  'settings.modals.wslProxy.support.updateWsl',
  'settings.modals.wslProxy.support.noDistribution',
  'settings.modals.wslProxy.support.noWsl2Distribution',
  'settings.modals.wslProxy.support.noUserDistribution',
  'settings.modals.wslProxy.messages.scope',
  'settings.modals.wslProxy.messages.integrationDetail',
  'settings.modals.wslProxy.messages.autoProxyDetail',
  'settings.modals.wslProxy.messages.unmanaged',
  'settings.modals.wslProxy.messages.configurationDrift',
  'settings.modals.wslProxy.messages.tunModeWarning',
  'settings.modals.wslProxy.messages.restartRequired',
  'settings.modals.wslProxy.messages.running',
  'settings.modals.wslProxy.messages.restartConfirmation',
  'settings.modals.wslProxy.messages.loadFailed',
  'settings.modals.wslProxy.notifications.enabled',
  'settings.modals.wslProxy.notifications.disabled',
  'settings.modals.wslProxy.notifications.restarted',
